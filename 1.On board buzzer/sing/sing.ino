...
void PlayTest()
{
 int length = sizeof(tune)/sizeof(tune[0]);   //Calculate the length of the song
 for(int x=0; x < length; x++)
  {
    tone(buzzer,tune[x]);
    delay(500*durt[x]);   //500 parameter can be modify by yourself
    noTone(buzzer);
  }
}
